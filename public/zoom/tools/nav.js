...
function websdkready() {
  ...
  var CLIENT_ID = "iy24eH6aTpuQbXSLdI6LQ";
   ...
   */
  var CLIENT_SECRET = "hWGU2QgevGMDwrd3WrCrylF1EoqdycWM";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "D:/SDKZOOM/zoom-sdk-web-2.12.2/Components/public/cdn.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
          window.open(joinUrl, "_blank");
          } else {
            var joinUrl = "D:/SDKZOOM/zoom-sdk-web-2.12.2/Components/public/index.html?" + testTool.serialize(meetingConfig);
            console.log(joinUrl);
            window.open(joinUrl, "_blank");
          }
        },
    ...
    var signature = generateSDKSignature({
      ...
      success: function (res) {
        ...
        if (document.getElementById('demoType').value === 'cdn') {
          ...
          var joinUrl =
          testTool.getCurrentDomain() +
          "D:/SDKZOOM/zoom-sdk-web-2.12.2/Components/public/index.html?" +
          testTool.serialize(meetingConfig);
          document.getElementById('copy_link_value').setAttribute('link', joinUrl);
          copyToClipboard('copy_link_value');
        }
